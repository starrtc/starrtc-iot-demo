...
typedef enum hiEN_VIU_ERR_CODE_E
{
    ...
    ERR_VI_DIS_NOT_INIT = 80,			/* dis not init */
    ERR_VI_DIS_NOT_SETATTR,			    /* dis attrs not set */
    ERR_VI_DIS_GETATTR_FAILED,			/* dis get attrs failed */	
    ERR_VI_DIS_FAILED,					/* dis exec failed */
    ERR_VI_DIS_ALREADY_INIT,			/* dis already init */
    ERR_VI_DIS_IS_RUNNING,				/* dis is running */
} EN_VIU_ERR_CODE_E;
...
#define HI_ERR_VI_DIS_NOT_INIT			HI_DEF_ERR(HI_ID_VIU, EN_ERR_LEVEL_ERROR, ERR_VI_DIS_NOT_INIT)
#define HI_ERR_VI_DIS_NOT_SETATTR       HI_DEF_ERR(HI_ID_VIU, EN_ERR_LEVEL_ERROR, ERR_VI_DIS_NOT_SETATTR)
#define HI_ERR_VI_DIS_GETATTR_FAILED    HI_DEF_ERR(HI_ID_VIU, EN_ERR_LEVEL_ERROR, ERR_VI_DIS_GETATTR_FAILED)
#define HI_ERR_VI_DIS_FAILED       	 	HI_DEF_ERR(HI_ID_VIU, EN_ERR_LEVEL_ERROR, ERR_VI_DIS_FAILED)
#define HI_ERR_VI_DIS_ALREADY_INIT      HI_DEF_ERR(HI_ID_VIU, EN_ERR_LEVEL_ERROR, ERR_VI_DIS_ALREADY_INIT)
#define HI_ERR_VI_DIS_IS_RUNNING        HI_DEF_ERR(HI_ID_VIU, EN_ERR_LEVEL_ERROR, ERR_VI_DIS_IS_RUNNING)
...
typedef struct hiVI_DIS_ATTR_STATIC_S
{
	...
	HI_U32  				u32FeaturelessLevel;		/* Threshold level for determining there are less features in the screen. 
														   range:[0~7] */
	HI_U32  				u32RollingShutterCoef;		/* Rolling shutter distortion correction coefficient. range:[0~100]*/
}VI_DIS_STATIC_ATTR_S;

typedef struct hiVI_DIS_DYNAMIC_ATTR_S
{
